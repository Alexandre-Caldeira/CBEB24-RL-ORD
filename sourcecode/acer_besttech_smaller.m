...
%% TRAIN AGENT
signal_freq_bins =  88; %[82   90    84    86    88    90    92    94    96];
...
for idx_window = 1:n_total_episodes
    ...
    if mod(idx_window,5)==0
        ...
        for idx_window_teste = 1:n_total_episodes_teste
            ...
            %          +((tdr)^2)/(100))*el;
            test_reward = +( -(((100-fp_des)^2)/100+(fp_des^2)/-100)...
                +((tfp)^2)/(-100) ...
                 +((tdr)^2)/(100))*el/100;
...
% save(['log10states_ws_snr_',num2str(snr),'numep',num2str(n_total_episodes),'dt','23-Apr-2024-14-26-09','.mat'])
% 

% save(['2osave_besttech_smaller',num2str(snr),'numep',num2str(n_total_episodes),'dt','25-Apr-2024-14-26-09','.mat'])
save(['2o_treino_besttech_smaller',num2str(snr),'numep',num2str(n_total_episodes),'dt','25-Apr-2024-14-26-09','.mat'])